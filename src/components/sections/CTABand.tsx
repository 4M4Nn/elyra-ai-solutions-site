    ...
    <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
      <div className="bg-brand-gradient flex flex-col items-center gap-6 rounded-3xl px-6 py-14 text-center text-white sm:px-12">
        ...
        <p className="max-w-2xl text-white/90">
          Start your 14-day free trial of Elyra SEO+AEO Agent and start tracking your visibility across
          search engines and AI answer engines from a single dashboard. No card required.
        </p>
        <Link
          href="/signup"
